...
1. A complete Run of Cas9 guides
2. A short Run of Cas12a guides
3. A short example in crisprVerse syntax, comparing bowtie to CHOPOFF 
 for finding a justified candidate guide 
4. A Full example in crisprVerse syntax, comparing bowtie to CHOPOFF 
